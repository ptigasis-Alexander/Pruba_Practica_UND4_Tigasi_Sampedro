...
\begin{document}
	...
	\end{center}
		...
		\scanfig{DiagrmaMaquinaEstadoCorregido.png}{0.92\linewidth}{Máquina de estados (P3) corregido --- .}{fig:p3p4}
	...
	\section{Anexos}
		...
		\scanfig{Hoja1.png}{0.92\linewidth}{Diagrama de clases UML (P1) y diagrama de actividades (P2) --- manuscrito original.}{fig:p1p2}
		
		\scanfig{Hoja2.png}{0.92\linewidth}{Máquina de estados (P3) corregido --- manuscrito original.}{fig:p3p4}
